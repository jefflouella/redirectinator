...
export class SchemaService {
  ...
  public generateHowToSchema(): any {
    return {
      ...
      'description': 'Step-by-step guide to using Redirectinator for professional URL redirect checking and monitoring',
   ...
   */
  public generateArticleSchema(title: string, description: string, publishDate: string): any {
    return {
      '@type': 'Article',
      ...
      'keywords': 'SEO, redirects, URL checking, technical SEO, website monitoring'
    };
  }
  ...
  public generateProductSchema(): any {
    return {
      ...
      'name': 'Redirectinator',
      'description': 'Professional URL redirect checker and monitoring tool for SEO professionals',
      'brand': {
        '@type': 'Brand',
        'name': 'Redirectinator',
        'url': 'https://redirectinator.com/'
      ...
      'review': [
        {
          ...
          'reviewBody': 'Excellent tool for bulk URL redirect checking. Saves hours of manual work.'
        }
      ]
    };
  }
  ...
  public generateServiceSchema(): any {
    return {
      ...
      'description': 'Professional service for analyzing URL redirects, monitoring website status, and providing SEO insights',
      'provider': {
        '@type': 'Person',
        '@id': 'https://redirectinator.com/#author',
        'name': 'Jeff Louella'
   ...
   */
  public generateBreadcrumbSchema(paths: Array<{ name: string; url: string }>): any {
    return {
      '@type': 'BreadcrumbList',
  ...
  public generateOrganizationSchema(): any {
    return {
      ...
      'description': 'Professional SEO tools and utilities for technical SEO professionals',
  ...
  public generatePersonSchema(): any {
    return {
      ...
      'description': 'SEO professional and developer specializing in technical SEO tools and automation',
   ...
   */
  public generateCompleteSchema(pageType: 'home' | 'about' | 'blog' | 'contact' = 'home'): SchemaData {
    const baseSchema = {
