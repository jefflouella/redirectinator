          ...
          <div className="prose prose-gray max-w-none">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
              <p className="text-blue-800 text-sm">
                <strong>Important:</strong> By accessing and using
                Redirectinator, you accept and agree to be bound by these Terms
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                agreement between you and Jeff Louella ("we," "us," or "our")
                regarding your use of Redirectinator ("the Service").
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Redirectinator is a professional URL redirect checker and
                monitoring tool designed for SEO professionals and technical
                marketers. The Service provides:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Process hundreds of URLs simultaneously with intelligent
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Discover historical URLs via Internet Archive integration
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Discover URLs using SEMrush data and analyze competitor
                    redirect patterns.
                  </p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Import URLs from CSV and XML files for bulk processing and
                    analysis.
                  </p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    Export results in multiple formats including CSV, JSON,
                    Excel, and detailed reports.
                  </p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    Organize and manage multiple projects with collaboration
                    features and team sharing.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                revocable license to use Redirectinator for its intended
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
                ...
                <ul className="text-red-700 text-sm space-y-1">
                  ...
                  <li>
                    • Violate any international, federal, state, or local
                    regulations
                  </li>
                  <li>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <ul className="text-green-700 text-sm space-y-1">
                  <li>
                    • Use the Service for personal and professional SEO analysis
                  </li>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Maintaining the security of your local data and ensuring
                    your browser and device are properly secured.
                  </p>
                </div>
                <div className="border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    Ensuring that URLs you submit for analysis are legitimate
                    and you have permission to analyze them.
                  </p>
                </div>
                <div className="border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    Complying with all applicable laws, regulations, and these
                    Terms when using the Service.
                  </p>
                </div>
                <div className="border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    Using the Service in a manner that respects the rights of
                    others and does not harm the Service or its users.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                ...
                <p className="text-blue-700 text-sm">
                  Redirectinator and its original content, features, and
                  functionality are owned by Jeff Louella and are protected by
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <p className="text-green-700 text-sm">
                  ...
                  Service, including analysis results and exported data. You
                  grant us a limited license to use feedback and suggestions for
              ...
              <div className="space-y-4">
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  ...
                  <p className="text-red-700 text-sm">
                    In no event shall Jeff Louella be liable for any indirect,
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-gray-700 text-sm">
                    ...
                    Service will be error-free or that results will be
                    completely accurate. You should verify all analysis results
                    independently.
                  </p>
                </div>
              </div>
            ...
            <section className="mb-8">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul className="text-blue-700 text-sm mt-2 space-y-1">
                  ...
                  <li>
                    • We do not store your URLs or analysis results permanently
                  </li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Redirectinator may integrate with or link to third-party
                services:
              </p>
              <div className="space-y-3">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      For historical URL discovery and analysis
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      For URL discovery and SEO analysis (requires valid API
                      key)
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      For privacy-focused usage analytics and feature tracking
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      For reliable application hosting and availability
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
              ...
              <p className="text-gray-600 mt-4">
                ...
                practices of any third-party services. Use of third-party
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                ...
                <ul className="text-gray-600 text-sm mt-2 space-y-1">
                  ...
                  <li>
                    • All provisions of these Terms that should survive
            ...
            <section className="mb-8">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <p className="text-blue-700 text-sm mb-4">
                  ...
                  the laws of the United States, without regard to conflict of
                  law principles.
                </p>
                <h4 className="font-semibold text-blue-800 mb-2">
                  Dispute Resolution
            ...
            <section className="mb-8">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mt-4">
                <p className="text-yellow-800 text-sm">
                  <strong>Important:</strong> Your continued use of
                  Redirectinator after any changes to these Terms constitutes
                  acceptance of the updated Terms. If you do not agree to the
                  new Terms, you should discontinue use of the Service.
                </p>
              </div>
            </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="text-sm text-gray-600 space-y-1">
                      <li>
                        <strong>Email:</strong> terms@redirectinator.com
                      </li>
                      <li>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-8">
              <p className="text-blue-800 text-sm text-center">
                <strong>Thank you for using Redirectinator.</strong>
                <br />
                By using our service, you agree to these Terms & Conditions and
                our commitment to providing a professional, secure, and reliable
                URL analysis tool.
              </p>
            </div>
          </div>
