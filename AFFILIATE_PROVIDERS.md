# Comprehensive Affiliate Link Providers Database
...
The Redirectinator uses pattern matching to detect affiliate links:
...
### **For Developers**
- ✅ **Comprehensive coverage** - 100+ affiliate providers detected
