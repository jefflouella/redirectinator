...
const AFFILIATE_DATABASE = [
  // Major Affiliate Networks
  {
    ...
    description: 'Major affiliate marketing platform with sophisticated bot detection'
  },
  {
  ...
  {
    patterns: ['bit.ly', 't.co', 'tinyurl.com', 'ow.ly', 'buff.ly', 'is.gd', 'v.gd', 'shorturl.at', 'rb.gy', 'cutt.ly', 'short.io', 'tiny.cc', 'shorten.asia', 'goo.gl', 't.ly', 'short.cm', 'adf.ly', 'sh.st', 'bc.vc', 'adfly.com', 'sh.st', 'bc.vc', 'adf.ly', 'sh.st', 'bc.vc'],
  ...
  {
    patterns: ['instagram.com/affiliate', 'facebook.com/affiliate', 'twitter.com/affiliate', 'pinterest.com/affiliate'],
  ...
  {
    patterns: ['shopify.com/affiliate', 'woocommerce.com/affiliate', 'bigcommerce.com/affiliate', 'magento.com/affiliate'],
  ...
  {
    patterns: ['booking.com/affiliate', 'expedia.com/affiliate', 'hotels.com/affiliate', 'tripadvisor.com/affiliate', 'kayak.com/affiliate'],
  ...
  {
    patterns: ['creditkarma.com/affiliate', 'nerdwallet.com/affiliate', 'bankrate.com/affiliate', 'lendingtree.com/affiliate'],
  ...
  {
    patterns: ['microsoft.com/affiliate', 'adobe.com/affiliate', 'autodesk.com/affiliate', 'intuit.com/affiliate'],
  ...
  {
    patterns: ['steam.com/affiliate', 'epicgames.com/affiliate', 'origin.com/affiliate', 'battle.net/affiliate'],
  ...
  {
    patterns: ['coursera.org/affiliate', 'udemy.com/affiliate', 'skillshare.com/affiliate', 'masterclass.com/affiliate'],
  ...
  {
    patterns: ['myfitnesspal.com/affiliate', 'fitbit.com/affiliate', 'garmin.com/affiliate', 'strava.com/affiliate'],
  ...
  {
    patterns: ['sephora.com/affiliate', 'ulta.com/affiliate', 'nordstrom.com/affiliate', 'macys.com/affiliate'],
  ...
  {
    patterns: ['hellofresh.com/affiliate', 'blueapron.com/affiliate', 'instacart.com/affiliate', 'doordash.com/affiliate'],
  ...
  {
    patterns: ['netflix.com/affiliate', 'spotify.com/affiliate', 'hulu.com/affiliate', 'disneyplus.com/affiliate'],
  ...
  {
    patterns: ['wayfair.com/affiliate', 'overstock.com/affiliate', 'homedepot.com/affiliate', 'lowes.com/affiliate'],
  ...
  {
    patterns: ['carmax.com/affiliate', 'cargurus.com/affiliate', 'autotrader.com/affiliate', 'cars.com/affiliate'],
  ...
  {
    patterns: ['geico.com/affiliate', 'progressive.com/affiliate', 'statefarm.com/affiliate', 'allstate.com/affiliate'],
  ...
  {
    patterns: ['zillow.com/affiliate', 'realtor.com/affiliate', 'redfin.com/affiliate', 'trulia.com/affiliate'],
  ...
  {
    patterns: ['indeed.com/affiliate', 'linkedin.com/affiliate', 'monster.com/affiliate', 'careerbuilder.com/affiliate'],
  ...
  {
    patterns: ['chewy.com/affiliate', 'petco.com/affiliate', 'petsmart.com/affiliate', 'petfinder.com/affiliate'],
  ...
  {
    patterns: ['rei.com/affiliate', 'dickssportinggoods.com/affiliate', 'basspro.com/affiliate', 'cabelas.com/affiliate'],
  ...
  {
    patterns: ['buybuybaby.com/affiliate', 'babiesrus.com/affiliate', 'toysrus.com/affiliate', 'target.com/affiliate'],
  ...
  {
    patterns: ['staples.com/affiliate', 'officedepot.com/affiliate', 'quill.com/affiliate', 'newegg.com/affiliate'],
