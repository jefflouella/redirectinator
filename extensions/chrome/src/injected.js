...
(function () {
  ...
  class AdvancedRedirectDetector {
    ...
    monitorLocationMethods() {
      ...
      try {
        ...
        console.log(
          'Redirectinator Advanced: Could not override location.assign:',
          error.message
        );
      }
      ...
      try {
        ...
        console.log(
          'Redirectinator Advanced: Could not override location.replace:',
          error.message
        );
      }
    }
    ...
    monitorHistoryMethods() {
      ...
      try {
        ...
        console.log(
          'Redirectinator Advanced: Could not override history.pushState:',
          error.message
        );
      }
      ...
      try {
        ...
        console.log(
          'Redirectinator Advanced: Could not override history.replaceState:',
          error.message
        );
      }
    }
    ...
    monitorScriptInjection() {
      ...
      try {
          ...
          document.createElement = function (tagName) {
            ...
            if (tagName?.toLowerCase() === 'script') {
              try {
                ...
                console.log(
                  'Redirectinator Advanced: Could not override script src property:',
                  srcError.message
                );
              }
            }
        ...
        console.log(
          'Redirectinator Advanced: Could not override document.createElement:',
          error.message
        );
      }
    }
  ...
  try {
    ...
    console.warn(
      'Redirectinator Advanced: Error initializing injected script:',
      error
    );
  }
